...
import { User, Home, Zap, Phone, Mail, Hash } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Your account and connection details (managed by admin)
        </p>
      </div>
                ...
                <div className="sm:col-span-2 border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
                    ...
                    <InfoRow
                      ...
                      value={`${Number(conn.sanctionedLoad)} kW`}
                    />
                    <InfoRow
      ...
      <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-100 rounded-lg text-sm text-blue-700">
        ...
        <div>
          ...
          <p className="mt-0.5 text-blue-600">
            Profile and connection information is managed by the admin. Please
            contact the Oasis Venetia Heights management office for any
            changes.
          </p>
        </div>
      </div>
